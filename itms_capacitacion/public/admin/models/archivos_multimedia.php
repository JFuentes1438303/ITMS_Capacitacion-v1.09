...
<?php  
	...
	echo "<div class='col-sm-4 t_centro'>";
		echo "<a href='../../temporal/multimedia/$rruta' class='btn btn-sm b_descargar' onclick='return descargar()' title='Descargar Archivo' download='$nnombre'><i class='fas fa-download'></i></a>";
	echo "</div>";
	echo "</div>";
	echo "</form>";
	}	
