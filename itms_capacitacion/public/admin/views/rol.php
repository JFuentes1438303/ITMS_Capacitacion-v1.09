    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="list-group list-group-flush b_right">
          ...
          <ul class="navbar-nav list-group-item-action enlaces2 b_bottom2">
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                <a class="dropdown-item" href="../../admin/controllers/reporte_usuarios">   Reporte de usuarios
                </a>
                <hr>
      ...
      <div id="page-content-wrapper">
        ...
        <div class="container div6 color2">
          ...
          <div id="alerta"></div>
          <form action="../../admin/models/rol.php" method="POST" name="form5">
          <br>
          <div class="row">
            <div class="col-sm-7 t_centro">
              <h5>Ingrese el documento del usuario que desea modificar el rol</h5>
            </div>
            <div class="col-sm-5">
              <input type="text" name="doc_rol" id="rol" class="form-control inputs" placeholder="documento.." autocomplete="off">
            </div>
          </div>
          <br>
          <div class="row centro">
            <button type="button" onclick="validar();" class="btn btn-sm btn-outline-dark">Buscar</button>
          </div>
          <br>
          <div class="row centro">
        ...
        <script src="../../../vendor/js/validar5.js"></script>
