    ...
    <div class="d-flex toggled" id="wrapper">
      ...
      <div id="sidebar-wrapper">
        ...
        <div class="list-group list-group-flush b_right">
          ...
          <a href="../../user/views/archivos_documentos" class="list-group-item list-group-item-action enlaces">
            <div class="barra"></div>
...
?>
            <div class="container div4 color2">
              ...
              <form action="../../user/controllers/perfil.php" method="POST" name="form3">
