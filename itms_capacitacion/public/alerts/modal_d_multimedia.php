      ...
      <div class="modal" id="myModal" style="margin-left: -5.5%; margin-top: 5%">
        <div class="modal-dialog">
          <div class="modal-content d_modal">
			...
			<h5>Solo estan permitidos archivos con el formato (.pdf/ .swf/ .rar/ .zip)</h5>
            </div>

            <!-- Modal footer -->
            <div class="modal-footer centro color2">
              <a href="../../../public/admin/views/archivos_multimedia.php" class="btn btn-sm btn-outline-dark">Volver</a>
            </div>
