        ...
        <div class="modal-dialog">
          <div class="modal-content d_modal">
            ...
            <div class="modal-body t_centro color2">
				<h5>Solo estan permitidos archivos con el formato (.mp4/ .wmv/ .avi/ .mpg)</h5>
            </div>

            <!-- Modal footer -->
            <div class="modal-footer centro color2">
              <a href="../../../public/admin/views/archivos_video.php" class="btn btn-sm btn-outline-dark">Volver</a>
            </div>
